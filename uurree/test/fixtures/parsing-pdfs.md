...
(also available [here](http://big.dada.pink/scott-documents.tar.gz)).
...
They fed into [this program](https://github.com/tlevine/scott), which was primarily
...
[Data Wranglers DC](http://www.meetup.com/Data-Wranglers-DC/events/160592492/).
Materials are [here](https://github.com/tlevine/data-wranglers-dc-pdfs)

If you are just interested in running a text search across many different PDF
files, read [this](/!/techcamp-sarajevo-searching-lots-of-files/).

And there are some notable softwares that I haven't used myself.

* People talk a lot about [Tabula](http://tabula.technology/).
* I have heard that some proprietary OCR softwares provide better parses than
    the free ones, but I have yet to need them.
* [PDF Tables](https://pdftables.com/) is proprietary, but I'm told that it
